...
import (
	...
	pbCampaign "github.com/nikolablesic/proto/campaign"
...
func main() {
	...
	pbCampaign.RegisterCampaignServiceServer(s, service)
	// Serve gRPC server
	log.Println("Serving gRPC on 0.0.0.0:9010")
	go func() {
	...
	// Register Greeter
	err = pbCampaign.RegisterCampaignServiceHandler(context.Background(), gwmux, conn)
	if err != nil {
	...
	log.Println("Serving gRPC-Gateway on http://0.0.0.0:9011")
